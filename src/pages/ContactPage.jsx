...
const ContactPage = () => {
  return (
    <div className='bg-custom-ash'>
      ...
      <form action="" className='flex flex-col bg-white w-[90%] mx-auto gap-[20px] px-[25px] py-[50px] rounded '>
      ...
      <div className="contacy-cards pb-[30px] mt-[50px]">
        <div className="card border border-custom-pink px-[20px] py-[30px] rounded w-[90%] mx-auto">
